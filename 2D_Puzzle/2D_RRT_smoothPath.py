...
def plan_path(q_pWorld: list, table_height: float, scenario: str, stepsize: float, box_size: list, hold_size: list):
    """
    Plans a path using the RRT solver at height = 0.0. 
    The path is then moved onto the table of the given scenario. 
    """
...
if __name__ == "__main__":
    ...
    # save the config file for debugging information
    f = open("config.g", "w")   
